var ODATA_URL = Xrm.Page.context.getClientUrl() + '/XRMServices/2011/OrganizationData.svc';
var EntityName;
var EntitySchemaName;
var ParentGUID, CopyGUID;
...
function errorRetrieveAttribute(error) {
    $('#loadingDiv').hide();
}
...
function createRecord(entityObject) {
    ...
    $.ajax({
        ...
        datatype: "json",
        data: jsonEntity,
        url: ODATA_URL + "/" + EntitySchemaName + "Set",
        ...
        success: function (data, textStatus, XmlHttpRequest) {
            if (data != null && data.d != null) {
                $('#loadingDiv').hide();
                CopyGUID = data.d[PrimaryIdSchemaName];
                Xrm.Utility.openEntityForm(EntityName, CopyGUID);
            }
        },
